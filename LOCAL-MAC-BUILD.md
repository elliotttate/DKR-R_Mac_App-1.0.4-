...
export DKR_RELEASE_VERSION=1.0.5-beta.10-macos.4
...
ROMs, saves and user-imported packs remain outside the bundle. The committed
SR.GU pack is validated and staged automatically; source builds need no
separate texture download or conversion dependency.
